...
interface ConfluenceClient {
    ...
    suspend fun createPage(value: PageContentInput, updateParameters: UpdateParameters): ConfluencePage

    suspend fun updatePage(pageId: String, value: PageContentInput, updateParameters: UpdateParameters): ConfluencePage
