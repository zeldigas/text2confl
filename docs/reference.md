...
pages when you need to look something up while working.
...
- [Markdown overview](./reference/markdown.md) - document structure, YAML front matter
    ...
    - [Code blocks](./reference/markdown/code.md)
    - [Diagrams](./reference/markdown/diagrams.md)
    - [Confluence-specific features](./reference/markdown/confluence-specific.md)
...
- [AsciiDoc overview](./reference/asciidoc.adoc) - document structure, page attributes
    ...
    - [Code blocks](./reference/asciidoc/code.adoc)
    - [Admonitions](./reference/asciidoc/admonitions.adoc)
    - [Table of contents](./reference/asciidoc/toc.adoc)
    - [Diagrams](./reference/asciidoc/diagrams.adoc)
    - [Includes](./reference/asciidoc/includes.adoc)
    - [Confluence-specific features](./reference/asciidoc/confluence-specific.adoc)
