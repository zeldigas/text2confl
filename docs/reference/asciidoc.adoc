...
You can read about supported attributes on link:./page-attributes.md[dedicated page].
...
You can read more about attributes that are special for text2confl on xref:./page-attributes.md[on dedicated page].
...
Each subpage is organized in sections showing AsciiDoc source alongside the rendered Confluence output.