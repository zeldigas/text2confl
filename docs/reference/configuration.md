...
See [Customize the autogenerated source note](../how-to/customize-autogenerated-note.md) for the default note template and how to customize it with `__doc-root__` and `__file__` variables.
