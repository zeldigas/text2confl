...
You can find details about supported languages and other code block attributes on separate page: xref:../code-blocks.adoc[Code highlight]

Supported AsciiDoc native attributes:

- `language` controls highlighting
- `%linenums` to enable line numbers
