...
*text2confl* adds a custom _asciidoc macro_ that helps you to insert any Confluence macro that does not require complex parameters in simple way: `+confl_macro:MACRONAME[key1=value1 key2=value2]+`.
