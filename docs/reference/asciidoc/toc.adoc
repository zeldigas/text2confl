...
With macro, you can specify xref:../toc-attributes.md[all supported attributes], but note that almost all of them are not standard.
...
If you want to customize it for all pages do in xref:../configuration.adoc[`.text2confl.yml` file]
