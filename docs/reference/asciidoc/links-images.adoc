...
|Cross-link to another page | `+xref:../markdown.md[Markdown]+` | xref:../markdown.md[Markdown]
|Cross-link to anchor on another page | `+xref:../markdown.md#sSupported-features[anchors inside page]+` | xref:../markdown.md#sSupported-features[anchors inside page]
...
You can find details about supported attributes on link:../image-attributes.md[page "Controlling images representation"].
